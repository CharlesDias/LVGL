...
#  if EVDEV_CALIBRATE
#    define EVDEV_HOR_MIN      3963               /*to invert axis swap EVDEV_XXX_MIN by EVDEV_XXX_MAX*/
#    define EVDEV_HOR_MAX        95	              /*"evtest" Linux tool can help to get the correct calibraion values>*/
#    define EVDEV_VER_MIN      3961
#    define EVDEV_VER_MAX       165
//#    define EVDEV_HOR_MIN      3937               /*to invert axis swap EVDEV_XXX_MIN by EVDEV_XXX_MAX*/
//#    define EVDEV_HOR_MAX       129	              /*"evtest" Linux tool can help to get the correct calibraion values>*/
//#    define EVDEV_VER_MIN      4040
//#    define EVDEV_VER_MAX       281
